    ...
    // =============================================================================
      ...
      children: [
        ...
        }, 
        {
          path: '/dashboard/user',
          name: 'dashboard-user',
          component: () => import('./views/dashboards/DashboardUser.vue'),
          meta: {
            rule: 'user'
          }
        }, 
        {
          ...
          component: () => import('./views/dashboards/DashboardManager.vue'),
          meta: {
            rule: 'editor'
          }
        }, 
        {
          ...
          name: 'create-user',
          component: () => import('./views/admin/create_user.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          name: 'create-faculty',
          component: () => import('./views/admin/create_faculty.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          component: () => import('./views/admin/create_department.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          component: () => import('./views/research/create_research.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          name: 'create-research',
          component: () => import('./views/research/create_manager_research.vue'),
          meta: {
            rule: 'editor'
          }
        },
        {
          path: '/apps/research/research-list',
          name: 'app-research-list',
          component: () => import('@/views/apps/research-list/ResearchList.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Research' },
        ...
        {
          path: '/apps/research/research-edit/:userId',
          name: 'app-research-edit',
          component: () => import('@/views/apps/research-list/EditResearch.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Research' },
            ...
            pageTitle: 'Research Edit',
            rule: 'admin'
          }
        },
        {
          path: '/apps/manager/research-list',
          name: 'app-manager-list',
          component: () => import('@/views/apps/manager-list/ResearchList.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Research' },
        ...
        {
          path: '/apps/manager/research-edit/:userId',
          name: 'app-manager-edit',
          component: () => import('@/views/apps/manager-list/EditResearch.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Research' },
