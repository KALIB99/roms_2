...
export default {
  pages: {
    ...
    data: [
      ...
      {title: "eCommerce Dashboard",        url: "/dashboard",                icon: "HomeIcon",           is_bookmarked: false},
      ...
      // UI ELEMENTS
      {title: "Data List - List View",     url: "/ui-elements/research/list-view",    icon: "ListIcon",           is_bookmarked: false},
      {title: "Data List - Thumb View",    url: "/ui-elements/research/thumb-view",   icon: "ImageIcon",          is_bookmarked: false},
