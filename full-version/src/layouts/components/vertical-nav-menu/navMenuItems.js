...
export default [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        slug: 'Upload Research',
        icon: 'LayersIcon',
        i18n: 'Upload Research'
      },
      {
        url: '/manager/research/create',
        name: 'Upload Research',
        slug: 'Upload Research',
        icon: 'LayersIcon',
        i18n: 'Upload Research'
      ...
      {
        url: '/apps/research/research-list',
        name: 'Manage Research',
        icon: 'ListIcon',
        i18n: 'Manage Research'
      },
      {
        url: '/apps/manager/research-list',
        name: 'My Research',
        icon: 'ListIcon',
        i18n: 'My Researchs'
      }
  ...
  //       submenu: [
  //         {
  //           url: '/ui-elements/research/list-view',
  //           name: 'List View',
  //           slug: 'research-list-view',
  //           i18n: 'ListView'
  //         },
  //         {
  //           url: '/ui-elements/research/thumb-view',
  //           name: 'Thumb View',
  //           slug: 'research-thumb-view',
  //           i18n: 'ThumbView'
  //         }
  //       ]
  //     },
