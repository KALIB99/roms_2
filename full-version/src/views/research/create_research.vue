...
<template>
    <vx-card title="Create Research" code-toggler>
        ...
        <div class="mt-5">
            <form-wizard color="rgba(var(--vs-primary), 1)" :title="null" :subtitle="null" finishButtonText="Submit" @on-complete="formSubmitted">
                ...
                <tab-content title="Co-authorship" class="mb-5" icon="feather icon-briefcase">
                    <div class="vx-row">
                          <div  class="vx-col md:w-1/2 w-full mt-5">
                            <vs-input  label="Co-Authors" v-model="coAuthor" class="w-full" />
                        </div>
                        <div  class="vx-col md:w-1/2 w-full mt-5">
                    ...
                    <div class="vx-row">
                        <div class="vx-col md:w-1/2 w-full mt-5">
                           ...
                           <div class="vx-col md:w-1/2 w-full mt-5"> 
                            ...
                            <div class="vx-col md:w-1/2 w-full mt-5"> 
                                <vs-input type="text" label="Research Link"    class="w-full"  v-model="research_link"/>
                           </div>
                    </div>
                </tab-content>
            </form-wizard>
...
export default {
  ...
  methods: {
    formSubmitted () {
      ...
      params.append('research_link', this.research_link)
      ...
      axios.post(`http://${window.location.host}/api/research-outputs/create`, params, config)
        .then(() => { 
          this.$vs.loading.close() 
          this.$vs.notify({
            title: 'Success',
            text: 'Research Created Succesfully',
            iconPack: 'feather',
